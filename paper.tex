...
\title{Working paper: Modeling industrial symbiotic processes from a complex systems perspective}
...
%%%%%%%%%%%%%%%%%%
\subsubsection*{Growing the circular economy network}
...
\subsubsection*{Indicators of Circularity}
